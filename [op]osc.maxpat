...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 40.0, 798.0, 42.0, 20.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 130.0, 766.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 40.0, 778.0, 36.0, 20.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 56.5, 746.0, 47.0, 20.0 ],
					"text" : "curve~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 745.5, 349.0, 50.0, 18.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 613.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 825.0, 105.0, 20.0 ],
					"text" : "send~ [pat]dacLR"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 8.0, 661.0, 51.0, 20.0 ],
					"text" : "gate~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 545.0, 156.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1.0, 21.0, 168.0, 20.0 ],
									"text" : "sprintf [shapes]OscTrigger%d"
								}
...
,
					"patching_rect" : [ 56.5, 719.0, 114.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 869.5, 279.0, 210.0, 32.0 ],
					"text" : ";\r[shapes]shapesIn oscConnect 11 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 828.0, 250.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 800.5, 250.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 773.0, 250.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 745.5, 250.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 718.0, 250.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 246.0, 250.0, 32.5, 20.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.5, 201.0, 132.0, 20.0 ],
					"text" : "scale 15. 120. 150. 15."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -7.5, 375.0, 33.0, 20.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -7.5, 408.0, 73.0, 19.0 ],
					"text" : "*~ 0.083333"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -7.5, 435.0, 53.0, 20.0 ],
					"text" : "pow~ 2."
				}
...
, 											{
												"box" : 												{
													...
													"text" : "sprintf \\; [pat]localWave%d $1"
												}
...
,
									"patching_rect" : [ 93.75, 404.0, 53.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Arial",
										"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 807.0, 415.0, 68.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"text" : "sprintf [shapes]OscOnOff%d"
								}
...
,
					"patching_rect" : [ 232.5, 99.0, 54.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -7.5, 228.0, 56.0, 22.0 ],
					"text" : "AUDIO"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.5, 293.0, 108.0, 22.0 ],
					"text" : "GRID OUTPUT"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 254.25, 448.0, 50.0, 18.0 ],
									"text" : "0. 25"
								}
...
,
					"patching_rect" : [ 728.0, 415.0, 79.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 160.5, 135.0, 42.0, 20.0 ],
									"text" : "*~ 0.2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 78.0, 208.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ -7.5, 461.0, 83.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 											{
												"box" : 												{
													...
													"text" : "sprintf \\; [pat]localTime%d $1"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 384.0, 52.0, 73.0 ],
									"text" : ";\r[pat]localTime11 $1"
								}
...
,
					"patching_rect" : [ 652.0, 415.0, 76.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 285.0, 33.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ -29.5, 491.0, 41.0, 20.0 ],
					"text" : "gate~"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1.0, 21.0, 139.0, 20.0 ],
									"text" : "sprintf [pat]localTime%d"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -7.5, 39.0, 71.0, 15.0 ],
					"text" : "loadmess #4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 902.0, 196.0, 226.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 695.5, 223.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "js_osc.js",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 690.5, 146.0, 110.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -7.5, 324.0, 47.0, 18.0 ],
					"text" : "$1 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -7.5, 349.0, 46.0, 20.0 ],
					"text" : "line 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 690.0, 105.0, 20.0 ],
					"text" : "send~ [pat]dacLR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 146.0, 158.0, 32.5, 20.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 209.0, 778.0, 94.0, 20.0 ],
					"text" : "s [shapes]oscIn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 182.5, 647.0, 63.0, 20.0 ],
					"text" : "delay 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 209.0, 754.0, 165.0, 18.0 ],
					"text" : "/shapes/grid/led/set $1 $2 $3"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1182.0, 142.0, 1182.0, 507.0, 432.0, 853.0, 176.0, 853.0, 176.0, 645.0, 17.5, 645.0 ],
					"source" : [ "obj-64", 7 ]
				}
